                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".lastname" id="lastname" name="lastname"
                                        ...
                                        validators={{required,minLength: minLength(3), maxLength:maxLength(5)}}/>
                                    <Errors 
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        validators={{required,minLength: minLength(8), maxLength:maxLength(10)}}/>
                                    <Errors 
                                        className="text-danger" model=".telnum" show="touched" messages={{
                                        required: 'Required, ',minLength: ' Must be greater than 7 numbers, ',
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors 
                                        ...
                                        required: 'Required, ',validEmail: ' Not a valid email'}}/>
                                </Col>
                            </Row>
                            <Row className="form-group">
